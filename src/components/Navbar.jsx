...
import PrfoleAvatar from '../assets/profile-av.avif';
...
function Navbar() {
    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-purple-600 navbar-with-hero">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Tour Guide</span>
                </Link>

                <div className="flex items-center">
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-0 mr-14" id="navbar-user">
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-purple-600 dark:border-purple-600">
                            <li>
                    ...
                    <div className="flex items-center space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <div className='relative'>
                            ...
                            >
                                ...
                                <img className="w-8 h-8 rounded-full" src={PrfoleAvatar} alt="user photo" />
                            </button>
                            {isDropdownOpen && (
